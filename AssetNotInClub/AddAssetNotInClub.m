...
writetable( results_bislett, filename, 'writevariablenames', true, 'quotestrings', true);

filename = 'add_new_asset_nydalen.csv';    %must end in csv
writetable( results_nydalen, filename, 'writevariablenames', true, 'quotestrings', true);

filename = 'add_new_asset_ringnes_park.csv';    %must end in csv
writetable( results_ringnes_park, filename, 'writevariablenames', true, 'quotestrings', true);

filename = 'add_new_asset_schous_plass.csv';    %must end in csv
writetable( results_schous_plass, filename, 'writevariablenames', true, 'quotestrings', true);

filename = 'add_new_asset_fagerborg.csv';    %must end in csv
writetable( results_fagerborg, filename, 'writevariablenames', true, 'quotestrings', true);
