...
MR_cc_adj_peak = getMarginalRevenue(add_rec_cc_adj, sim_usage_cc_adj_peak, 9, 180);

sim_usage_cc_adj_pre = [0.2379, 0.4262, 0.3224];
MR_cc_adj_pre = getMarginalRevenue(add_rec_cc_adj, sim_usage_cc_adj_pre, 9, (peak_hrs_cc_adj - 6) * 60 );

sim_usage_cc_adj_post = [0.3698, 0.2510, 0.3750];
MR_cc_adj_post = getMarginalRevenue(add_rec_cc_adj, sim_usage_cc_adj_post, 9, (23 - peak_hrs_cc_adj) * 60);
...
MR_mr_peak = getMarginalRevenue(add_rec_mr, sim_usage_mr_peak, 9, 180);

sim_usage_mr_pre = [0.0213, 0.0162, 0.0376, 0.0583, 0.1128, 0.1444, 0.1914, 0.2300, 0.1641 ];
MR_mr_pre = getMarginalRevenue(add_rec_mr, sim_usage_mr_pre, 9, (peak_hrs_mr - 6) * 60);

sim_usage_mr_post = [0.2406, 0.0370, 0.0311, 0.0409, 0.0599, 0.0515, 0.1011, 0.1905, 0.2432 ];
MR_mr_post = getMarginalRevenue(add_rec_mr, sim_usage_mr_post, 9,(23 - peak_hrs_mr) * 60);
...
MR_cc_fxd_peak = getMarginalRevenue(add_rec_cc_fxd, sim_usage_cc_fxd_peak, 8, 180);

sim_usage_cc_fxd_pre = [0.1375, 0.2796, 0.3703, 0.1889];
MR_cc_fxd_pre = getMarginalRevenue(add_rec_cc_fxd, sim_usage_cc_fxd_pre, 8, (peak_hrs_cc_fxd - 6) * 60);

sim_usage_cc_fxd_post = [0.3229, 0.1107, 0.2695, 0.2927];
MR_cc_fxd_post = getMarginalRevenue(add_rec_cc_fxd, sim_usage_cc_fxd_post, 8,(23 - peak_hrs_cc_fxd) * 60);
...
MR_ab_peak = getMarginalRevenue(add_rec_ab, sim_usage_ab_peak, 8, 180);

sim_usage_ab_pre = [0.6948, 0.2817];
MR_ab_pre = getMarginalRevenue(add_rec_ab, sim_usage_ab_pre, 8, (peak_hrs_ab - 6) * 60);

sim_usage_ab_post = [0.5859, 0.4099];
MR_ab_post = getMarginalRevenue(add_rec_ab, sim_usage_ab_post, 8,(23 - peak_hrs_ab) * 60);
...
MR_ci_peak = getMarginalRevenue(add_rec_ci, sim_usage_ci_peak, 8, 180);

sim_usage_ci_pre = [0.7100, 0.2663];
MR_ci_pre = getMarginalRevenue(add_rec_ci, sim_usage_ci_pre, 8, (peak_hrs_ci - 6) * 60);

sim_usage_ci_post = [0.6255, 0.3703];
MR_ci_post = getMarginalRevenue(add_rec_ci, sim_usage_ci_post, 8,(23 - peak_hrs_ci) * 60);
...
MR_cp_peak = getMarginalRevenue(add_rec_cp, sim_usage_cp_peak, 9, 180);

sim_usage_cp_pre = [0.4882, 0.4879];
MR_cp_pre = getMarginalRevenue(add_rec_cp, sim_usage_cp_pre, 9, (peak_hrs_cp - 6) * 60);

sim_usage_cp_post = [0.5021, 0.4938];
MR_cp_post = getMarginalRevenue(add_rec_cp, sim_usage_cp_post, 9,(23 - peak_hrs_cp) * 60);
...
MR_cp_pl_peak = getMarginalRevenue(add_rec_cp_pl, sim_usage_cp_pl_peak, 8, 180);

sim_usage_cp_pl_pre = [0.5642, 0.3184];
MR_cp_pl_pre = getMarginalRevenue(add_rec_cp_pl, sim_usage_cp_pl_pre, 8, (peak_hrs_cp_pl - 6) * 60);

sim_usage_cp_pl_post = [0.6000, 0.3125];
MR_cp_pl_post = getMarginalRevenue(add_rec_cp_pl, sim_usage_cp_pl_post, 8, (23 - peak_hrs_cp_pl) * 60);
...
MR_ht_peak = getMarginalRevenue(add_rec_ht, sim_usage_ht_peak, 8, 180);

sim_usage_ht_pre = [0.5419, 0.4347];
MR_ht_pre = getMarginalRevenue(add_rec_ht, sim_usage_ht_pre, 8, (peak_hrs_ht - 6) * 60);

sim_usage_ht_post = [0.6583, 0.3370];
MR_ht_post = getMarginalRevenue(add_rec_ht, sim_usage_ht_post, 8, (23 - peak_hrs_ht) * 60);
...
MR_ibr_peak = getMarginalRevenue(add_rec_ibr, sim_usage_ibr_peak, 8, 180);

sim_usage_ibr_pre = [0.4938, 0.2734];
MR_ibr_pre = getMarginalRevenue(add_rec_ibr, sim_usage_ibr_pre, 8, (peak_hrs_ibr - 6) * 60);

sim_usage_ibr_post = [0.6302, 0.1597];
MR_ibr_post = getMarginalRevenue(add_rec_ibr, sim_usage_ibr_post, 8, (23 - peak_hrs_ibr) * 60);
...
MR_llp_pl_peak = getMarginalRevenue(add_rec_llp_pl, sim_usage_llp_pl_peak, 8, 180);

sim_usage_llp_pl_pre = [0.6146, 0.3615];
MR_llp_pl_pre = getMarginalRevenue(add_rec_llp_pl, sim_usage_llp_pl_pre, 8,(peak_hrs_llp_pl - 6) * 60);

sim_usage_llp_pl_post = [0.6109, 0.3849];
MR_llp_pl_post = getMarginalRevenue(add_rec_llp_pl, sim_usage_llp_pl_post, 8, (23 - peak_hrs_llp_pl) * 60);
...
MR_p_peak = getMarginalRevenue(add_rec_p, sim_usage_p_peak, 8, 180);

sim_usage_p_pre = [0.5242, 0.2654, 0.1711];
MR_p_pre = getMarginalRevenue(add_rec_p, sim_usage_p_pre, 8, (peak_hrs_p - 6) * 60);

sim_usage_p_post = [0.4631, 0.2396, 0.2860];
MR_p_post = getMarginalRevenue(add_rec_p, sim_usage_p_post, 8, (23 - peak_hrs_p) * 60);
...
MR_sr_peak = getMarginalRevenue(add_rec_sr, sim_usage_sr_peak, 10, 180);

sim_usage_sr_pre = [0.2673, 0.7093];
MR_sr_pre = getMarginalRevenue(add_rec_sr, sim_usage_sr_pre, 10, (peak_hrs_sr - 6) * 60);

sim_usage_sr_post = [0.3823, 0.6135];
MR_sr_post = getMarginalRevenue(add_rec_sr, sim_usage_sr_post, 10, (23 - peak_hrs_sr) * 60);
...
MR_sm_peak = getMarginalRevenue(add_rec_sm, sim_usage_sm_peak, 8, 180);

sim_usage_sm_pre = [0.3305, 0.3639, 0.2817];
MR_sm_pre = getMarginalRevenue(add_rec_sm, sim_usage_sm_pre, 8, (peak_hrs_sm - 6) * 60);

sim_usage_sm_post = [0.4865, 0.2427, 0.2667];
MR_sm_post = getMarginalRevenue(add_rec_sm, sim_usage_sm_post, 8, (23 - peak_hrs_sm) * 60);
...
MR_wcp_peak = getMarginalRevenue(add_rec_wcp, sim_usage_wcp_peak, 8, 180);

sim_usage_wcp_pre = [0.7041, 0.2723];
MR_wcp_pre = getMarginalRevenue(add_rec_wcp, sim_usage_wcp_pre, 8, (peak_hrs_wcp - 6) * 60);

sim_usage_wcp_post = [0.5951, 0.4015];
MR_wcp_post = getMarginalRevenue(add_rec_wcp, sim_usage_wcp_post, 8, (23 - peak_hrs_wcp) * 60);
...
for i = 1:num_additions
    ...
    purchase_list_prioritized{i,4} = 100*purchase_list_prioritized{i,3} / exercise_min_per_day; 
...
filename = 'purchase_list_prioritized_bislett.csv';    %must end in csv
